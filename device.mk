...
PRODUCT_COPY_FILES += \
    ...
    $(DEVICE_PATH)/audio/mixer_paths_mtp.xml:$(TARGET_COPY_OUT_VENDOR)/etc/mixer_paths_qrd_sku2.xml \
...
# Non lineage stuffs useful for roms based on caf sources
ifeq ($(TARGET_INCLUDE_BOOST_FRAMEWORKS), true)
$(call inherit-product, vendor/xiaomi/ugglite/perf/perf-vendor.mk)
endif
